...
export const paymentdone = (id) => {
  return httpClient.get(`customer/payment/${id}`);
};
...
export default {createAccount, bookService,getAllOrders,cancelService,giveFeedback,deleteCustomer,generatedBill,paymentdone}